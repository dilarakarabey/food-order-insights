...
- The bundled Excel exporter rejects direct message/order identifier and raw-email fields, neutralizes formula-like receipt strings, and writes OOXML using Python's standard library only. It does not download packages or contact external services.
